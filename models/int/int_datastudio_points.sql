...
inverter_base as (
    select
        ...
        ia.device_id,
        ia.device_name,
        coalesce(ia.device_type, 'inverter')::text as device_type,
...
weather_base as (
    select
        ...
        wa.device_id,
        wa.device_name,
        coalesce(wa.device_type, 'weather_station')::text as device_type,
    ...
    from {{ ref('int_weather_station_analog') }} wa
    join public.power_plant pp
...
meter_base as (
    select
        ...
        ma.active_power_kw,
        ma.power_reactive_kvar,
        ma.apparent_power_kva,
        ma.power_factor,
        ma.frequency_hz,
        ma.imported_active_energy_kwh,
        ma.exported_active_energy_kwh,
        ma.imported_reactive_energy_kvarh,
        ma.exported_reactive_energy_kvarh,
        ma.current_phase_a_a,
        ma.current_phase_b_a,
        ma.current_phase_c_a,
        ma.line_voltage_ab_v,
        ma.line_voltage_bc_v,
        ma.line_voltage_ca_v
    from {{ ref('stg_meter_analog') }} ma
    join public.power_plant pp
